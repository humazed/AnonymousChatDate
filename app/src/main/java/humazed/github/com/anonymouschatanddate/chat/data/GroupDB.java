...
public class GroupDB {
    ...
    public void addGroup(Group group) {
        ...
        values.put(FeedEntry.COLUMN_GROUP_NAME, group.getGroupInfo().get("name"));
        values.put(FeedEntry.COLUMN_GROUP_ADMIN, group.getGroupInfo().get("admin"));

        for (String idMenber : group.getMember()) {
    ...
    public Group getGroup(String id){
        ...
        while (cursor.moveToNext()) {
            ...
            newGroup.getGroupInfo().put("name", nameGroup);
            newGroup.getGroupInfo().put("admin", admin);
            newGroup.getMember().add(member);
        }
        return newGroup;
    }
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                if (!listKey.contains(idGroup)) {
                    ...
                    mapGroup.get(idGroup).getMember().add(member);
                }
            }
            cursor.close();
        } catch (Exception e) {
